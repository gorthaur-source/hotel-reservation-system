...
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ID FROM ROOM WHERE ROOM_NUMBER = 'C2'), (SELECT ID FROM GUEST WHERE LAST_NAME = 'Young'), '2020-01-01');
